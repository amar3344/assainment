          ...
          <div className="teamWrapperHead1">
            ...
            <div className="teamWrapperNav">
              <div
                className="headNav"
                style={{
                  color: navActive.teamActivity ? "#D9B75E" : "#333333",
                }}
                onClick={() =>
                  setNavActive({
                    teamActivity: true,
              ...
              <div
                className="headNav"
                style={{
                  color: navActive.teamInteraction ? "#D9B75E" : "#333333",
                }}
                onClick={() =>
                  setNavActive({
                    teamActivity: false,
              ...
              <div
                className="headNav"
                style={{ color: navActive.teamTopics ? "#D9B75E" : "#333333" }}
                onClick={() =>
                  setNavActive({
                    teamActivity: false,
                    teamInteraction: false,
              ...
              <div
                className="headNav"
                style={{
                  color: navActive.teamTrackers ? "#D9B75E" : "#333333",
                }}
                onClick={() =>
                  setNavActive({
                    teamActivity: false,
              ...
              <div
                className="headNav"
                style={{ color: navActive.teamSmart ? "#D9B75E" : "#333333" }}
                onClick={() =>
                  setNavActive({
                    teamActivity: false,
                    teamInteraction: false,
              ...
              <div
                className="headNav"
                style={{ color: navActive.teamScore ? "#D9B75E" : "#333333" }}
                onClick={() =>
                  setNavActive({
                    teamActivity: false,
                    teamInteraction: false,
              ...
              <div
                className="headNav"
                style={{
                  color: navActive.teamCoaching ? "#D9B75E" : "#333333",
                }}
                onClick={() =>
                  setNavActive({
                    teamActivity: false,
