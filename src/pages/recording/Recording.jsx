...
const Recording = () => {
  ...
  const handleProgress = (state) => {
    console.log(state);
    const playedSeconds = new Date(state.playedSeconds * 1000)
      .toISOString()
      .slice(11, 19);
    setStates({
      ...states,
    ...
    <>
      ...
      <div className="twoIcons">
        ...
        <div className="second">
          <img
            src="https://img.icons8.com/external-simple-solid-edt.graphics/24/000000/external-Plus-add-and-remove-simple-solid-edt.graphics.png"
            alt=""
          />
        </div>
      </div>
      <div className="recording">
        <div className="part1">
          <img
            src="https://img.icons8.com/color/30/000000/video-call--v1.png"
            alt="video"
          />
        ...
        <div className="part2">
          <div className="upper">
            ...
            <div className="controllers">
              <img
                src="https://img.icons8.com/external-inkubators-glyph-inkubators/20/ffffff/external-previous-video-interface-inkubators-glyph-inkubators.png"
                alt="previous"
                className="previous"
              />
              <img
                src={
                  playing
                    ? "https://img.icons8.com/ios/40/FFFFFF/circled-pause.png"
                    : "https://img.icons8.com/ios/40/ffffff/play-button-circled--v1.png"
                }
                alt="play"
                className="play"
                onClick={() =>
              ...
              />
              <img
                src="https://img.icons8.com/ios-filled/24/ffffff/end--v1.png"
                alt="next"
                className="next"
              />
            </div>
        ...
        <div className="part3">
          ...
          <div className="ok">
            ...
            <div className="speed" onClick={(e) => setChange(!change)}>
              ...
              <img
                src="https://img.icons8.com/material/24/ffffff/sort-down--v1.png"
                alt="speed"
              />
            </div>
          </div>
