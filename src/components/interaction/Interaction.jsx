  ...
  return (
    <div className="interactionWrapper">
      <div className="interactionWrapperHead">
        <div
          className={
            interactionname.talkRatio ? "changei" : "interactionWrapperHeadName"
          }
          onClick={() =>
            setInteractionName({
              talkRatio: true,
        ...
        <div
          className={
            interactionname.longMono ? "changei" : "interactionWrapperHeadName"
          }
          style={{
            background: interactionname.longMono ? "white" : "#D9D9D9",
            borderBottom: interactionname.longMono
              ? "0px"
              : "2px solid #000000",
          }}
          onClick={() =>
        ...
        <div
          className={
            interactionname.longStory ? "changei" : "interactionWrapperHeadName"
          }
          style={{
            background: interactionname.longStory ? "white" : "#D9D9D9",
            borderBottom: interactionname.longStory
              ? "0px"
              : "2px solid #000000",
          }}
          onClick={() =>
        ...
        <div
          className={
            interactionname.interactivity
              ? "changei"
              : "interactionWrapperHeadName"
          }
          style={{
            background: interactionname.interactivity ? "white" : "#D9D9D9",
            borderBottom: interactionname.interactivity
              ? "0px"
              : "2px solid #000000",
          }}
          onClick={() =>
        ...
        <div
          className={
            interactionname.patience ? "changei" : "interactionWrapperHeadName"
          }
          style={{
            background: interactionname.patience ? "white" : "#D9D9D9",
            borderBottom: interactionname.patience
              ? "0px"
              : "2px solid #000000",
          }}
          onClick={() =>
        ...
        {interactionname.talkRatio && (
          <div className="interactionWrapperCallDuration">
            <div className="talkRatioInfo">
              ...
              <div className="talkRatioInfoSub">
                Percentages of call in which team member spoke
              </div>
            </div>
