  ...
  return (
    <div className="activityWrapper">
      <div className="activityWrapperHead">
        <div
          className={
            activityname.callDuration ? "change" : "activityWrapperHeadName"
          }
          onClick={() =>
            setActivityName({
              callDuration: true,
        ...
        <div
          className={
            activityname.weeklyVolume ? "change" : "activityWrapperHeadName"
          }
          style={{
            background: activityname.weeklyVolume ? "white" : "#D9D9D9",
            borderBottom: activityname.weeklyVolume
              ? "0px"
              : "2px solid #000000",
          }}
          onClick={() =>
        ...
        <div
          className={
            activityname.weeklyDuration ? "change" : "activityWrapperHeadName"
          }
          style={{
            background: activityname.weeklyDuration ? "white" : "#D9D9D9",
            borderBottom: activityname.weeklyDuration
              ? "0px"
              : "2px solid #000000",
          }}
          onClick={() =>
        ...
        <div
          className={
            activityname.totalVolume ? "change" : "activityWrapperHeadName"
          }
          style={{
            background: activityname.totalVolume ? "white" : "#D9D9D9",
            borderBottom: activityname.totalVolume
              ? "0px"
              : "2px solid #000000",
          }}
          onClick={() =>
        ...
        <div
          className={
            activityname.totalDuration ? "change" : "activityWrapperHeadName"
          }
          style={{
            background: activityname.totalDuration ? "white" : "#D9D9D9",
            borderBottom: activityname.totalDuration
              ? "0px"
              : "2px solid #000000",
          }}
          onClick={() =>
